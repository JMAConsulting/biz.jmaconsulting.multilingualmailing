 ...
 */
class CRM_Multilingualmailing_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Multilingualmailing_Upgrader(
   ...
   *
   * @code
   * CRM_Multilingualmailing_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
